...
Use the the ground fish survey data frame example from lab 2. Create a `for()` loop that sums the total abundance (`num_cpue`) for each fish species, for each year.
