...
# YOUR CODE HERE
#A
Bedford_ts$Date <- ymd(Bedford_ts$Date) #convert date to appropriate format

#B
Bedford_ts$year <- year(Bedford_ts$Date) #extract year
Bedford_ts$month <- month(Bedford_ts$Date) #extract month
Bedford_ts$day <- day(Bedford_ts$Date) #extract day

#C
Bedford_ts$month_name <- month(Bedford_ts$Date, label = TRUE)
